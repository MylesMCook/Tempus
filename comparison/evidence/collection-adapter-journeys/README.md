...
- [Journeys](journeys.md) and [raw stages](journeys.json): 19 authored tasks, 19 validated files retained in journey-files/. Failed or incomplete records are retained.
...
```sh
node comparison/export-evidence.mjs verify comparison/evidence/collection-adapter-journeys
```
