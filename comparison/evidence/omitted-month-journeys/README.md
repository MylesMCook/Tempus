...
- [Journeys](journeys.md) and [raw stages](journeys.json): 21 authored tasks, 21 validated files retained in journey-files/. Failed or incomplete records are retained.
...
```sh
node comparison/export-evidence.mjs verify comparison/evidence/omitted-month-journeys
```
