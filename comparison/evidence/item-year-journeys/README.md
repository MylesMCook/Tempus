...
- [Journeys](journeys.md) and [raw stages](journeys.json): 20 authored tasks, 20 validated files retained in journey-files/. Failed or incomplete records are retained.
...
```sh
node comparison/export-evidence.mjs verify comparison/evidence/item-year-journeys
```
