...
- [Journeys](journeys.md) and [raw stages](journeys.json): 22 authored tasks, 22 validated files retained in journey-files/. Failed or incomplete records are retained.
...
```sh
node comparison/export-evidence.mjs verify comparison/evidence/range-policy-source-replay
```
