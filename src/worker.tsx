...
const app = defineApp([
  ({ response, rw }) => {
    response.headers.set(
      ...
      `default-src 'self'; script-src 'self' 'nonce-${rw.nonce}'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self'; connect-src 'self'; object-src 'none'; base-uri 'none'; frame-ancestors 'none'; form-action 'none'`,
    );
